...
//    $object->fields['ref']['visible'] = 0;
	...
	print '<input type="submit" class="button" name="addnew" value="' . dol_escape_htmltag($langs->trans("CEHCreate&New")) . '">';
	print '&nbsp; ';
...
if (($id || $ref) && $action == 'edit') {
	...
	print '<input type="submit" class="button" name="saveaddnew" value="' . dol_escape_htmltag($langs->trans("CEHSaveAddNew")) . '">';
